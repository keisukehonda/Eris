...
object AccrualFailureDetector {
  def realClock: () ⇒ Long = () ⇒ NANOSECONDS.toMillis(System.nanoTime)
}
/**
...
*/
   ...
   */
  private def cumulativeDistributionFunction(x: Double, mean: Double, stdDeviation: Double): Double = {
...
private object HeartbeatHistory {
 ...
 * for empty HeartbeatHistory, i.e. throws AritmeticException.
 */
private case class HeartbeatHistory private (
  maxSampleSize: Int,
